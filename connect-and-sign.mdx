...
[This video](https://dynamic-labs.github.io/readme-embeds/videos/connect_authenticate.mov)
shows our [demo site](demo.dynamic.xyz). Here we start with a connected user who
