...
Any user who connect, but does not authenticate, will appear in your dashboard as a `Visitor`. You'll be able to see them in your [user management table](https://app.dynamic.xyz/dashboard/users/visitors) or in [analytics](https://app.dynamic.xyz/dashboard/analytics) under as `Visitors`.