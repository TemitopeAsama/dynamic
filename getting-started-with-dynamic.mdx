...
> 
> If you use NextJS with React 17 or below please follow the instructions, [here](/docs/nextjs-with-react-17-with-dynamic-react-sdk-0140).
...
4. (optional) [ Configure your site's CORS origins](/docs/security)
